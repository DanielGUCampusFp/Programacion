...
VALUES 
  ('Torneo de Baloncesto - Final', '2025-03-15', 'Gimnasio Municipal'),
  ('Entrenamiento General de Atletismo', '2025-02-05', 'Pista Olímpica'),
  ('Reunión Anual de Socios', '2025-04-20', 'Sala de Conferencias del Club'),
  ('Clase Abierta de Yoga', '2025-02-25', 'Sala de Actividades');
