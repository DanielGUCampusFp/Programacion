...
$datos = array(
    'messages' => array(
        array('role' => 'system', 'content' => 'Responde siempre en español y como si fueses un libro de recetas'),
        array('role' => 'user', 'content' => 'Dame la receta de la tarta de queso.')
    ),
    "temperature"=> 1,
    "max_tokens"=> -1,
    "stream"=> false
...
// Convertir a JSON y verificar errores
